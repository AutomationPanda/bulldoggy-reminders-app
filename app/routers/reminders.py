...
async def get_reminders_list_row(
  ...
  reminder_list = storage.get_list(reminders_id)
  selected_list = storage.get_selected_list()
...
async def delete_reminders_list_row(
  ...
  storage.delete_list(reminders_id)
  storage.reset_selected_after_delete(reminders_id)
...
async def patch_reminders_list_row_name(
  ...
  storage.update_list_name(reminders_id, new_name)
  storage.set_selected_list(reminders_id)
  return _get_reminders_grid(request, storage)
...
async def post_reminders_new_list_row(
  ...
  reminders_id = storage.create_list(reminder_list_name)
  storage.set_selected_list(reminders_id)
  return _get_reminders_grid(request, storage)
